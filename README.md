# Bolt-Cycle-Hold
Bolt Cycle Hold mod for STALKER G.A.M.M.A  

This mod allows you to delay cycling the bolt for certain supported weapons in STALKER GAMMA. By default, holding down the fire keybind will prevent the cycling of the bolt. You can also change this to allow cycling of the bolt using a separate keybind in the MCM.  

You will be unable to reload if you haven't bolted the weapon.  
...
## Compatible Weapons  
Below is the list of (currently) compatible weapons:  
Mosin  
R700 and its mods  
Kar98k and its mods  
dvl10 , both versions  
